...
namespace Alger.Utils.Extensions
{
   public static class StringExt
    {

        public static string ubbtohtml(this string content)  //ubb转html
        {
            ...
            content = Regex.Replace(content, @"\[img](?<img>.+?)\[/img]", "<img src='${img}' alt=''/>");//ubb转换
        ...
        public static string DoHtmlToUBB(this string _Html)
        {
